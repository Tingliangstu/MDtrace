...
**Folder**
   `example/CNT <https://github.com/Tingliangstu/mdtrace/tree/main/example/CNT>`_
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/CNT/SED/CNT-SED.svg
   :alt: CNT SED result
   :width: 85%
   :align: center
...
**Folder**
   `example/In_plane_graphene_gpumd <https://github.com/Tingliangstu/mdtrace/tree/main/example/In_plane_graphene_gpumd>`_
...
**Lattice-dynamics comparison**
   ...
   lattice-dynamics dispersion and overlaying it on the mdtrace result.

**Representative results**

Raw mdtrace SED map:

.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/In_plane_graphene_gpumd/SED/graphene_all-SED.png
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/In_plane_graphene_gpumd/SED/compare_LD/Graphene.png
...
**Folder**
   `example/MoS2_gpumd <https://github.com/Tingliangstu/mdtrace/tree/main/example/MoS2_gpumd>`_
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/MoS2_gpumd/SED/bulk_MoS2-SED.png
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/MoS2_gpumd/SED/LORENTZ-fitting-0-qpoint.png
...
**Folder**
   `example/Silicon_primitive_gpumd <https://github.com/Tingliangstu/mdtrace/tree/main/example/Silicon_primitive_gpumd>`_
...
**Lattice-dynamics comparison**
   Use the scripts in ``SED/compare_LD`` to compare mdtrace output with
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/Silicon_primitive_gpumd/SED/silicon-SED.png
...
.. image:: https://raw.githubusercontent.com/Tingliangstu/mdtrace/main/example/Silicon_primitive_gpumd/SED/compare_LD/Silicon.png
...
Partial SED is not local spatial-bin SED. mdtrace requires a supercell-to-
...
For polar materials, mdtrace can show LO-TO splitting only when the MD trajectory
...
LO-TO splitting during mdtrace post-processing.
...
`issue #31 <https://github.com/Tingliangstu/mdtrace/issues/31>`_ illustrate the
...
`mdtrace example library <https://github.com/Tingliangstu/mdtrace/tree/main/example>`_.
